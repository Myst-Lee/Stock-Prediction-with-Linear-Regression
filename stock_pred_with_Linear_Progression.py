...
if readme:
    ...
    st.write("In order to try ", "<strong>Sell Strategy</strong>", " and ", "<strong>Update Stock</strong>", ", please download the sample template through checkbox ""Download Sample Template"")
